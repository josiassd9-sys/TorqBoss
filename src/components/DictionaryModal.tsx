      ...
      {isOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <motion.div 
            ...
            className="relative bg-white rounded-3xl p-8 w-full max-w-4xl shadow-2xl h-[80vh] flex flex-col"
          >
            <div className="flex justify-between items-center mb-8 shrink-0">
              <div className="flex items-center gap-3 text-left">
                 ...
                 <div>
                   ...
                   <p className="text-xs text-gray-400 font-bold uppercase tracking-widest">Componentes Automotivos</p>
                 </div>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 text-center shrink-0">
               <p className="text-gray-400 text-xs italic font-medium">
                Este catálogo auxilia no cadastro rápido de componentes preventivos.
               </p>
            </div>
          </motion.div>
        </div>
